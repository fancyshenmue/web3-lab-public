    ...
    <div className="space-y-8">
      <header className="mb-10">
        <h2 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-4 flex items-center gap-4">
          Profile
          {isWalletUser && (
            <span className="px-3 py-1.5 bg-green-500/10 border border-green-500/20 text-green-400 text-sm rounded-md font-mono mt-1">SIWE</span>
          )}
        </h2>
      ...
      <div className={`rounded-2xl p-6 border backdrop-blur-md shadow-2xl ${
        ...
        <div className="flex items-center gap-4">
          {userInfo?.picture ? (
            ...
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-green-500 to-teal-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-green-500/20">
              ⟠
            </div>
          ) : (
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white text-xl font-bold shadow-lg shadow-emerald-500/20">
          ...
          <div className="min-w-0 flex-1">
            {isWalletUser ? (
              <>
                ...
                <span className="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded-full text-xs font-medium bg-green-500/20 text-green-300 border border-green-500/20">
                  ⟠ SIWE Connected
                </span>
              </>
            ) : (
        ...
        <div className="bg-[#1e293b]/70 border border-gray-700/50 shadow-2xl backdrop-blur-md rounded-2xl overflow-hidden">
          ...
          <div className="px-5 py-3.5 border-t border-gray-700/50 flex items-center justify-between">
            <button
              ...
              className="text-sm text-green-400 hover:text-green-300 font-medium transition-colors flex items-center gap-2"
            >
              🔄 Switch Wallet
            </button>
            {switchStatus && (
      ...
      <div className="hidden md:flex w-72 flex-col bg-[#0f172a] border-r border-gray-800 h-screen flex-shrink-0 z-10 shadow-xl">
        ...
        <div className="p-6">
           <div className="flex items-center gap-3 mb-6">
             <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold shadow-lg shadow-emerald-500/20">W</div>
                    ...
                    className={`w-full py-4 px-6 rounded-xl font-bold text-white shadow-lg transition-all border border-black/10 flex items-center justify-center
                      ${(!smartWalletAddress || (activeSection === 'deploy' ? (!deployName || !deploySymbol) : (!interactTokenAddress || interactTokenAddress === 'custom' || interactTo === 'custom')))
                        ...
                        : txLoading
                          ...
                          : 'bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 transform hover:-translate-y-0.5 hover:shadow-emerald-500/25'}
                    `}
                  >
                    {txLoading ? (
