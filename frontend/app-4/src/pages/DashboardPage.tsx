            ...
            {(['ERC20', 'ERC721', 'ERC1155'] as TokenType[]).map(t => (
              <button
                ...
                className={`w-full text-left pl-14 pr-4 py-2 text-[13px] transition-all
                  ${activeToken === t
                    ? 'text-white font-medium bg-violet-600/20 shadow-[inset_2px_0_0_0_#8b5cf6]'
                      ...
                      {activeToken !== 'ERC721' && (
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            className="w-full px-5 py-3.5 bg-[#0b1120] border border-gray-700 rounded-xl text-white placeholder-gray-700 focus:border-violet-500 focus:ring-1 focus:ring-violet-500 outline-none transition-all shadow-inner"
                            disabled={txLoading}
                          />
                        </div>
                      )}
