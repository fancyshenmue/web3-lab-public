...
export const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <div className="bg-violet-50 text-violet-800 text-xs px-3 py-2 rounded mb-4 text-center">
        {status}
      </div>
      ...
      <form className="flex flex-col space-y-3 p-4 border border-gray-200 rounded-lg bg-gray-50">
        <input 
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-violet-500"
          required 
        />
        <input 
          type="password" 
        ...
        <div className="flex space-x-2 pt-2">
          <button disabled={!loginChallenge} onClick={handleEmailSignIn} className="flex-1 bg-violet-600 text-white font-semibold py-2 rounded shadow hover:bg-violet-700 disabled:opacity-50">
            Sign In
          </button>
