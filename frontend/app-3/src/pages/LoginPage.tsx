...
export const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <div className="bg-amber-50 text-amber-800 text-xs px-3 py-2 rounded mb-4 text-center">
        {status}
      </div>
      ...
      <form className="flex flex-col space-y-3 p-4 border border-gray-200 rounded-lg bg-gray-50">
        ...
        <div className="flex space-x-2 pt-2">
          <button disabled={!loginChallenge} onClick={handleEmailSignIn} className="flex-1 bg-amber-600 text-white font-semibold py-2 rounded shadow hover:bg-amber-700 disabled:opacity-50">
            Sign In
          </button>
