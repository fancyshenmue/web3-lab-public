    ...
    <div className="space-y-8">
      <header className="mb-10">
        <h2 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-4 flex items-center gap-4">
          Profile
          {isWalletUser && (
            <span className="px-3 py-1.5 bg-purple-500/10 border border-purple-500/20 text-purple-400 text-sm rounded-md font-mono mt-1">SIWE</span>
          )}
        </h2>
          ...
          <div className="min-w-0 flex-1">
            {isWalletUser ? (
              <>
                ...
                <span className="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded-full text-xs font-medium bg-purple-500/20 text-purple-300 border border-purple-500/20">
                  ⟠ SIWE Connected
                </span>
              </>
            ) : (
        ...
        <div className="bg-[#1e293b]/70 border border-gray-700/50 shadow-2xl backdrop-blur-md rounded-2xl overflow-hidden">
          ...
          <div className="px-5 py-3.5 border-t border-gray-700/50 flex items-center justify-between">
            <button
              ...
              className="text-sm text-purple-400 hover:text-purple-300 font-medium transition-colors flex items-center gap-2"
            >
              🔄 Switch Wallet
            </button>
            {switchStatus && (
        ...
        <div className="px-5 py-3.5 border-b border-gray-700/50 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-xs font-semibold px-3 py-1.5 bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 hover:text-purple-300 rounded-lg transition-all border border-purple-500/20 disabled:opacity-50"
            >
      ...
      <div className="hidden md:flex w-72 flex-col bg-[#0f172a] border-r border-gray-800 h-screen flex-shrink-0 z-10 shadow-xl">
        ...
        <div className="p-6">
           <div className="flex items-center gap-3 mb-6">
             <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold shadow-lg shadow-blue-500/20">W</div>
                        ...
                        <div className="space-y-2 relative">
                          <label className="text-xs font-bold text-gray-400 uppercase tracking-widest pl-1 flex items-center justify-between">
                            ...
                            {activeSection === 'transfer' && selectedAsset && (
                              <span className="text-[9px] bg-indigo-500/20 text-indigo-400 px-2 py-0.5 rounded border border-indigo-500/30">
                    ...
                    className={`w-full py-4 px-6 rounded-xl font-bold text-white shadow-lg transition-all border border-black/10 flex items-center justify-center
                      ${(!smartWalletAddress || (activeSection === 'deploy' ? (!deployName || !deploySymbol) : (!interactTokenAddress || interactTokenAddress === 'custom' || interactTo === 'custom')))
                        ...
                        : txLoading
                          ...
                          : 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 transform hover:-translate-y-0.5 hover:shadow-blue-500/25'}
                    `}
                  >
                    {txLoading ? (
